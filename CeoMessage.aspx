<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CeoMessage.aspx.cs" Inherits="CeoMessage" %>
                ...
                <div class="section-content">
                    <div class="row" style="margin-top: 10%;margin-bottom: 5%;">
                        <article class="col-md-8">
                            <h3 style="color: white;text-align: left;">CEO Message</h3><br />
                        </article>
                ...
                <article class="col-md-12">
                    <div class="row">
                        <article class="col-md-8">
                            <div class="row">
                                <article class="col-md-12">
                                    <h3 style="color: darkred;border-bottom: inset;border-bottom-color: darkred;">CEO MESSAGE</h3>
                                    ...
                                    <div style="margin-top: 10%;">
                                        <p>On behalf of Urban Co-operative Bank Ltd. Bareilly, I would like to extend heartiest welcome to you at our website which is developed and designed to assist you in enjoying services being offered by our Bank. To emerge as one of the premier and most preferred banks in the Bareilly by adopting highest standards of professionalism and excellence in all the areas of working. Our Bank is the fastest growing bank of U.P. and is expanding its services in Bareilly, Pilibhit & Shahjahanpur Districts. As a Chairman of the bank, I wish to assure you that we are committed to offer gratifying banking services and experience to all of our regular and casual customers. We are trying to compete with our past performances and constantly try to update our banking products, services, systems and procedures. We heartily welcome any suggestions coming our way from our customers and any public member. So, if, you wish to say something about us, please do share your views. We are not only continuously expanding branch network but our range of products and services. Hope you enjoying our services.</p><br /><br /><br /><br /><br /><br /><br />
                                    </div>
                                </article>
                            </div>
                        </article>

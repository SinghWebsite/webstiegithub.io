<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="UrbaTraders.aspx.cs" Inherits="UrbaTraders" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style>
        .inner-banner{
            background-image: url(Bank-Image/Banner/urbantraderloan-banner.jpg);
                ...
                <div class="section-content">
                    <div class="row" style="margin-top: 10%;margin-bottom: 5%;">
                        <article class="col-md-8">
                            <h3 style="color: white;text-align: left;">Urban Traders Loan</h3><br />
                        </article>
                        <article class="col-md-4">
                             ...
                             <div class="banner-right">
                                 <li class="active">Urban Traders Loan</li>
                             </div>
                        </article>
                    </div>
                </div>
                ...
                <article class="col-md-12">
                    <div class="row">
                        <article class="col-md-8">
                            <div class="row">
                                <article class="col-md-12">
                                    <h3 style="text-align: center;font-weight: bolder;">Urban Traders</h3>
                                    ...
                                    <div style="margin-top: 7%;">
                                         <p style="line-height: 40px;"><span  >Urban trader is a loan product wherein limit is
                                        provided to the traders against mortgage of the property.</span></p>
                                    <p style="line-height: 40px;"><span  ><strong>Type of Facility:</strong> Overdraft
                                        Limit</span></p>
                                    <p style="line-height: 40px;"><span  ><strong>Purpose:</strong> To fulfil working
                                        capital requirement</span></p>
                                    <p style="line-height: 40px;"><span  ><strong>Eligibility: 1) </strong>Individuals
                                        /Units engaged in any commodity/goods and physical&nbsp; required by the
                                        community and trading in them is not prohibited by Law or opposed to public
                                        interest.</span></p>
                                    <p style="line-height: 40px;"><span  >2) Business unit should be profit making for the
                                        last two years</span></p>
                                    <p style="line-height: 40px;"><span  ><strong>Limit
                                          Size:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </strong>Minimum
                                        500000.00</span></p>
                                    <p style="line-height: 40px;"><span
                                         >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        Maximum 20000000.00</span></p>
                                    <p style="line-height: 40px;"><span  ><strong>Rate of Interest: 9 TO 12% based on
                                          credit rating</strong></span></p><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br /><br />

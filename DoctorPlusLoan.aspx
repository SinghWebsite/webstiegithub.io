<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="DoctorPlusLoan.aspx.cs" Inherits="DoctorPlusLoan" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style>
        .inner-banner{
            background-image: url(Bank-Image/Banner/doctor-banner.png);
                ...
                <div class="section-content">
                    <div class="row" style="margin-top: 10%;margin-bottom: 5%;">
                        <article class="col-md-8">
                            <h3 style="color: white;text-align: left;">Doctor Plus Loan</h3><br />
                        </article>
                        <article class="col-md-4">
                             ...
                             <div class="banner-right">
                                 <li class="active">Doctor Plus Loan</li>
                             </div>
                        </article>
                    </div>
                </div>
                ...
                <article class="col-md-12">
                    <div class="row">
                        <article class="col-md-8">
                            <div class="row">
                                <article class="col-md-12">
                                    <h3 style="text-align: center;font-weight: bolder;">DOCTOR PLUS LOAN</h3>
                                    ...
                                    <div style="margin-top: 10%;">
                                        <p style="line-height: 35px;"><span">Doctor Plus &nbsp;is a loan product
                                                      wherein limit/loan is provided to the Doctors &nbsp;for purpose of
                                                      providing medical services.</span></p>
                                                  <p style="line-height: 35px;"><span  ><strong>Type of Facility:</strong>
                                                      Loan/Limit</span></p>
                                                  <p style="line-height: 35px;"><span  ><strong>Purpose:</strong> To
                                                      fulfill working capital requirement for constructing nursing
                                                      homes/purchasing equipments and furniture etc.</span></p>
                                                  <p style="line-height: 35px;"><span  ><strong>Eligibility: 1)
                                                      </strong>MBBS, BDS, Aayush Doctors</span></p>
                                                  <br /><br /><p><span  ><strong>Rate of Interest:
                                                      </strong></span></p>
                                                  <table border="1" cellpadding="0" style="margin-top: 2%;margin-bottom: 35%;">
                                                    <tbody>
                                                      <tr>
                                                        <td>
                                                          <p><span  >(a).Working capital
                                                              /Equipments/Furniture</span></p>
                                                        </td>
                                                        <td>
                                                          <p><span  >8.75%</span></p>
                                                        </td>
                                                      ...
                                                      <tr>
                                                        <td>
                                                          <p><span  >(b).Nursing Home
                                                              Construction/Purchase</span></p>
                                                        </td>
                                                        <td>
                                                          <p><span  >8.25%</span></p>
                                                        </td>
